...
class DeleteNotesPage extends StatefulWidget {

  final int indexValue;

  DeleteNotesPage({Key? key,required this.indexValue}) : super(key: key);

  @override
  State<DeleteNotesPage> createState() => _DeleteNotesPageState();
}

class _DeleteNotesPageState extends State<DeleteNotesPage> {

  Future<List<Notes>> bringDelNotes() async {
    var noteList=await Notesdao().readDelNotes();
  ...
  Future<void> deleteNoteDelTbl(int note_id) async {
    await Notesdao().deleteDelNote(note_id);
  }
                    ...
                    return PopupMenuButton(
                      ...
                      onSelected: (menuItemValue){
                        ...
                        if (menuItemValue==2){
                          ...
                          deleteNoteDelTbl(note.note_id);
                          Fluttertoast.showToast(
                            msg: "Silinen notunuz geri yüklendi",
                            fontSize: 16.sp,
